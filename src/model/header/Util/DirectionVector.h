 ...
 * 
 * @tparam CoordinateT type of vector coordinates, must be numerical.
 */
template <typename CoordinateT = int>
...
public:
     ...
     */
    explicit DirectionVector(CoordinateT xAxis, CoordinateT yAxis = 0, CoordinateT zAxis = 0) : coordinates{xAxis, yAxis, zAxis} {}
